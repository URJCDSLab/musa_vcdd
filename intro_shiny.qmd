...
* Por diseño, pensados para ser impresos en papel, formato [pdf]{.red}
...
Informe estático con elementos interactivos (_widgets_)
...
* Aplicaciones [Reactivas]{.red} guían a las partes interesadas en la obtención e interpretación de resultados
...
Los [outputs]{.red}, i.e., gráficos, tablas, etc., se generan con R cuando los [inputs]{.red}, i.e., selecciones del usuario, cambian.
...
* `ui` (interfaz de usuario, página web). Contiene _inputs_ y _outputs_
